...
namespace Besm6.Loader
{
    ...
    public static class CosyCodec
    {
        ...
        //
        private static readonly ushort[] GostToUnicodeLat =
        {
            0x0030,0x0031,0x0032,0x0033,0x0034,0x0035,0x0036,0x0037,
            0x0038,0x0039,0x002b,0x002d,0x002f,0x002c,0x002e,0x0020,
            0x23e8,0x2191,0x0028,0x0029,0x00d7,0x003d,0x003b,0x005b,
            0x005d,0x002a,0x2018,0x2019,0x2260,0x003c,0x003e,0x003a,
            0x0041,0x0411,0x0042,0x0413,0x0414,0x0045,0x0416,0x0417,
            0x0418,0x0419,0x004b,0x041b,0x004d,0x0048,0x004f,0x041f,
            0x0050,0x0043,0x0054,0x0059,0x0424,0x0058,0x0426,0x0427,
            0x0428,0x0429,0x042b,0x042c,0x042d,0x042e,0x042f,0x0044,
            0x0046,0x0047,0x0049,0x004a,0x004c,0x004e,0x0051,0x0052,
            0x0053,0x0055,0x0056,0x0057,0x005a,0x203e,0x2a7d,0x2a7e,
            0x2228,0x2227,0x2283,0x00ac,0x00f7,0x2261,0x0025,0x25c7,
            0x007c,0x2015,0x005f,0x0021,0x0022,0x042a,0x00b0,0x2032,
        };
        ...
        public static char TextToUnicode(byte ch)
        {
            ...
            return GostToUnicode(TextToGost[ch & 077]);
        }
