...
namespace Besm6.Core
{
    ...
    /// Соответствует C++ референсу: int64_t mantissa; // Note: signed value
    /// </summary>
    public struct MantissaExponent
    {
        ...
        /// денормализовано из-за изменения знака (соответствует C++).
        /// </summary>
        ...
        /// Точный порт C++ MantissaExponent::multiply.
        /// </summary>
