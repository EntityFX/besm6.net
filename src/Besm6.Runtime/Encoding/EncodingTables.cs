...
{
    /// <summary>
    /// Data-only tables: COSY, GOST-10859, KOI-7, TEXT, architecture.
    /// </summary>
    internal static class EncodingTables
    {
        ...
        public static readonly ushort[] Koi7ToUnicodeTable = {
        ...
        public static readonly ushort[] GostToUnicodeLat = BuildGostToUnicodeLatTable();

        public static ushort[] BuildGostToUnicodeLatTable(){
        ...
        public static readonly byte[] TextToGost = {
            0x0F, // space (017)
            0x0E, // . (016)
            0x21, // Б (041)
            0x36, // Ц (066)
        ...
        public static readonly byte[] Tab0 = BuildTab0();

        public static byte[] BuildTab0(){
            byte[] t = new byte[256];
