...
> **Актуализация 30.08.2026.** Описанная ниже гипотеза про необходимость реализовать
> `002 рег/mod` неверна: эталонный процессор также считает эту команду illegal.
> Перехват арифметических ошибок и stack correction уже реализованы. FORTRAN и
> Pascal работают; текущие блокеры — первое расхождение до `*50 70226` в ALGOL и
> до `*57 6` в BEMSH, а также пути ресурсов. Актуальный план:
